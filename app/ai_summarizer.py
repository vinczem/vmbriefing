...
class AISummarizer:
    ...
    def summarize(self, news_items, current_date=None, part_of_day="napközben"):
        ...
        prompt = (
            ...
            f"FONTOS: A válaszodat pontosan ezzel a formátummal küldd:\n"
            f"[Napszaknak megfelelő köszönés]! Ma [Dátum] van, [Névnap] névnapja.\n"
            "Ide írd a hírek összefoglalóját...\n\n"
            "Tehát az ELSŐ sorban CSAK a köszönés és a dátum/névnap legyen, a hírek a második sortól kezdődjenek.\n"
